<?php
/**
 * @author    Siomkin Alexandr <siomkin.alexander@gmail.com>
 * @link      https://utm.space/
...
{
    public function __construct($max_credit_sum, $toPositiveBalance = false)
    {
        parent::__construct();

        if (!$toPositiveBalance) {
            $this->addElement(
                'text',
                'credit_sum',
                array(
